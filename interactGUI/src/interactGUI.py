...
#
# Just: "${PATH_TO_BINARY}/interactGUI --Ice.Config=${PATH_TO_CONFIG_FILE}"
#
...
if __name__ == '__main__':
    ...
    try:
        ...
        try:
            ...
            speech_proxy = RoboCompSpeech.SpeechPrx.uncheckedCast(basePrx)
    ...
    asrpublishI_ = asrpublishI.ASRPublishI(worker)
